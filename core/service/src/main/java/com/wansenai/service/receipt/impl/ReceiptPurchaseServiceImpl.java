    ...
    public Response<String> addOrUpdatePurchaseRefund(PurchaseRefundDTO purchaseRefundDTO) {
        ...
        if (isUpdate) {
            ...
            var updateMainResult = lambdaUpdate()
                    ...
                    .set(purchaseRefundDTO.getThisRefundAmount() != null, ReceiptPurchaseMain::getChangeAmount, purchaseRefundDTO.getThisRefundAmount().negate())
            ...
            var receiptMain = ReceiptPurchaseMain.builder()
                    ...
                    .changeAmount(purchaseRefundDTO.getThisRefundAmount().negate())
