        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :label-col="labelCol" :wrapper-col="wrapperCol" :label="t('sales.shipments.form.receiptNumber')" data-step="2"
              ...
              <a-input v-model:value="saleShipmentsFormState.receiptNumber"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
            ...
            <div class="table-operations">
              <vxe-grid ref='xGrid' v-bind="gridOptions">
                ...
                <template #barCode_edit="{ row }">
                  <vxe-select v-model="row.barCode" :placeholder="t('sales.shipments.form.table.inputBarCode')" @change="selectBarCode" :options="productLabelList" clearable filterable @click="loadProductSku"></vxe-select>
                </template>
