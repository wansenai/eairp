<template>
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate" v-text="t('warehouse.otherStorage.add')" />
        <a-button type="primary" @click="handleBatchDelete" v-text="t('warehouse.otherStorage.batchDelete')" />
        <a-button type="primary" @click="handleExport" v-text="t('warehouse.otherStorage.export.name')" />
...
export default defineComponent({
  ...
  setup() {
    ...
    const [registerTable, { reload, getSelectRows, getForm, getDataSource }] = useTable({
      title: t('warehouse.otherStorage.title'),
      rowKey: 'id',
