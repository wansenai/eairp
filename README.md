...
## Quick Start
```shell
docker pull wansenai/eairp:2.0.8

docker pull wansenai/eairp-web:2.0.8
```
## Run Server
...
```shell
docker run --name eairp -d -p 8080:8088 wansenai/eairp:2.0.8

docker run --name eairp-web -d -p 3000:80 -e API_BASE_URL=http://localhost:8080/erp-api wansenai/eairp-web:2.0.8
```
